...
<head>
    ...
    localStorage.setItem("key", "value");           
        ...
        <script type="text/javascript">
          ...
          if(localStorage.getItem("counter33"))
          {
             if(localStorage.getItem("counter33") >= 600)
             {
              var value = 601;
             }
             else
             {
              var value = localStorage.getItem("counter33");
             }
          }
          else
          {
           ...
           //document.getElementById('divcounter33').innerHTML = value;
           

         var counter33 = function ()
          {
            if(localStorage.getItem("counter33")>600)
           {
            ...
            if(value >= 600)
            {
              localStorage.setItem("counter33", 601);
              value = 601;
            }
            else
            {
              value = parseInt(value)+1;
              localStorage.setItem("counter33", value);
            }
            //document.getElementById('').innerHTML = value;
            };


            var interval = setInterval(function (){counter33();}, 1000);
          ...
          function inst()
          {
            swal('Instructions for this round : ','The winterfell has formed an alliance with the Dothrakis and the Targaryens to rebel against the alliance formed by the iron islands, the Greyjoys and the Baratheons. Amidst the rising tension and with everything on the line, the houses prepare for a bloody monsoon. So embrace yourself for a monsoon full of rage and a zeal to win. ','');
          }
          
          setInterval(function(){
            var sec=localStorage.getItem("counter33");
            ...
            <div class="form-holder">
                ...
                <div class="form-content">
                    ...
                    <div class="form-items">
                        ...
                        <form method="post" action="round3.php">
                         <div class="col-md-12">
                          <div class="row">
                           <div class="col-md-6">
 ...
 if(isset($_POST["submit"]))
   {
    ...
    //echo "<script>console.log('$x');</script>";
       ...
       $upQry="update wolf_of_estreet set acc='$newbal',p3_1='$amt1',p3_2='$amt2',p3_3='$amt3',p3_4='$amt4',p3_5='$amt5',p3_6='$amt6',p3_7='$amt7',p3_8='$amt8',p3_9='$amt9',p3_10='$amt10',p3_11='$amt11',p3_12='$amt12',p3_13='$amt13' where esid='$eid' ";
       @mysqli_query($link,$upQry)or die(mysqli_error($link));
       //echo "<script>swal('Thank You!', 'Your form was submitted','success');</script>";
       header("location:interval3.html");
