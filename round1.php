...
<head>
    ...
    global.onload = function () {           
        ...
        <script type="text/javascript">
          ...
          // //   // Retrieve
          // //   document.getElementById("result").innerHTML=localStorage.getItem("key"); 
          //   //ibal=parseInt(document.getElementById("bal").value);
          // }

          if(localStorage.getItem("counter11"))
          {
             if(localStorage.getItem("counter11") >= 600)
             {
              var value = 601;
             }
             else
             {
              var value = localStorage.getItem("counter11");
             }
          }
          else
          {
           ...
           //document.getElementById('divcounter11').innerHTML = value;
           

         var counter11 = function ()
          {
            if(localStorage.getItem("counter11")>600)
           {
            ...
            if(value >= 601)
            {
              localStorage.setItem("counter11", 601);
              value = 601;
            }
            else
            {
              value = parseInt(value)+1;
              localStorage.setItem("counter11", value);
            }
            //document.getElementById('').innerHTML = value;
            };

            var interval = setInterval(function (){counter11();}, 1000);
          ...
          function inst()
          {
            swal('Instructions for this round : ','As you, a trusted subject, assumes his position as the trusted treasurer, your kingdom enters the unknown. Unaware of what the future holds for you, you must think wisely before making any decisions.The kingdoms enjoy the beautiful spring sun with the light smell of flowers in the air. Get ready for a stimulation like never before. Invest Wisely!','');
          }
          
          setInterval(function(){
            var sec=localStorage.getItem("counter11");
        ...
        <div class="account">
            <div class="form-items">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                           <div id="bal" class="form-control" style="background-color: #57D38C; color: #fff;">1000</div></label><div style="margin-left: 10px;">Balance</div>
                        </div>
                        
                        <div class="col-md-4">
                           <div id="exp" class="form-control" value="0" style="background-color: #57D38C; color: #fff;">0</div></label><div style="margin-left: 10px;">Expenditure</div>
                        </div>
                    </div>
                    <div class="row">   
 ...
 if(isset($_POST["submit"]))
   {
    ...
    //echo "<script>console.log('$x');</script>";
       ...
       $upQry="update wolf_of_estreet set acc='$newbal',p1_1='$amt1',p1_2='$amt2',p1_3='$amt3',p1_4='$amt4',p1_5='$amt5',p1_6='$amt6',p1_7='$amt7',p1_8='$amt8',p1_9='$amt9',p1_10='$amt10',p1_11='$amt11',p1_12='$amt12',p1_13='$amt13' where esid='$eid' ";
       @mysqli_query($link,$upQry)or die(mysqli_error($link));
       //echo "<script>swal('Thank You!', 'Your form was submitted','success');</script>";
       header("location:interval1.html");
