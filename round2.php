...
<head>
    ...
    global.onload = function () {  
        ...
        <script type="text/javascript">
          ...
          if(localStorage.getItem("counter22"))
          {
             if(localStorage.getItem("counter22") >= 600)
             {
              var value = 601;
             }
             else
             {
              var value = localStorage.getItem("counter22");
             }
          }
          else
          {
           ...
           //document.getElementById('divcounter12').innerHTML = value;
           

         var counter22 = function ()
          {
            if(localStorage.getItem("counter22")>600)
           {
            ...
            if(value >= 601)
            {
              localStorage.setItem("counter22", 601);
              value = 601;
            }
            else
            {
              value = parseInt(value)+1;
              localStorage.setItem("counter22", value);
            }
            //document.getElementById('').innerHTML = value;
            };


            var interval = setInterval(function (){counter22();}, 1000);
          ...
          function inst()
          {
            swal('Instructions for this round : ','While the Lannisters, Starks, Greyjoys and the Baratheons enjoy the cool summer breeze of the Westeros; just a few miles away, residing on the vast land of Essos, the Dothrakis and the Targaryens are hit by a drought that has led to widespread famine in their kingdoms. With everything going on, the kingdoms prepare for the summers.','');
          }
          
          setInterval(function(){
            var sec=localStorage.getItem("counter22");
 ...
 if(isset($_POST["submit"]))
   {
    ...
    //echo "<script>console.log('$x');</script>";
       ...
       $upQry="update wolf_of_estreet set acc='$newbal',p2_1='$amt1',p2_2='$amt2',p2_3='$amt3',p2_4='$amt4',p2_5='$amt5',p2_6='$amt6',p2_7='$amt7',p2_8='$amt8',p2_9='$amt9',p2_10='$amt10',p2_11='$amt11',p2_12='$amt12',p2_13='$amt13' where esid='$eid' ";
       @mysqli_query($link,$upQry)or die(mysqli_error($link));
       //echo "<script>swal('Thank You!', 'Your form was submitted','success');</script>";
       header("location:interval2.html");
